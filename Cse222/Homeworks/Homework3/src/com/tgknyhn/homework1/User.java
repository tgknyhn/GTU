...
/**
 * User Interface for an automation system. Implements some methods as default.
 */
public interface User {
     ...
     */
    default void setAddress(String address) { /* empty */ }

    /**
     * Sets customer's phone number as the given parameter.
     * @param phoneNumber Phone number of the customer.
     */
    default void setPhoneNumber(long phoneNumber) { /* empty */ }
     ...
     */
    void commands(Company company, tkLinkedList<FurnitureBranch> branches, tkArrayList<User> employees);
